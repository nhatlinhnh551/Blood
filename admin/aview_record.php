...
<a href="index.php"> <button class="login-btn btn-primary-soft btn btn-icon-back" style="background-color: #D8EBFA; color: #1969AA;font-weight: 500; font-size: 16px; border: none;padding: 8px 20px 8px 20px; border-radius: 5px; cursor: pointer;">
