                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            ...
                                                            Email Bác Sĩ:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
                                                        <div class="h3-search" style="font-size:18px;">
                                                          
                                                        </div><br>
                                                        <div class="h3-search" style="font-size:18px;">
                                                            Tiêu Đề Cuộc Hẹn: '.$title.'<br>
                                                            Ngày Hẹn: '.$scheduledate.'<br>
                                                            Giờ Hẹn : '.$scheduletime.'<br>
                                                        </div>
                                                        <br>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="Submit" class="login-btn btn-primary btn btn-book" style="margin-left:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;" value="Đặt ngay" name="booknow"></button>
                                            </form>
                                            </td>
                                        </tr>
                                        '; 
